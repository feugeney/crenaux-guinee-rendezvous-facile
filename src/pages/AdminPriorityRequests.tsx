  ...
  return (
    <AdminHorizontalLayout>
      <div className="space-y-8">
        {/* Header moderne avec alerte */}
        <div className="space-y-2">
          <div className="flex items-center space-x-3">
            <div className="p-3 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl shadow-lg animate-pulse">
            ...
            <div>
              ...
              <p className="text-gray-600">Réservations nécessitant une validation urgente</p>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200/50">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-700">Traitées aujourd'hui</p>
