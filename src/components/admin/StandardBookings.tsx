...
export const StandardBookings = () => {
  ...
  useEffect(() => {
    fetchStandardBookings();
  }, []);

  const fetchStandardBookings = async () => {
    try {
      ...
      console.error('Erreur lors du chargement des rendez-vous standard:', error);
      toast.error('Erreur lors du chargement des rendez-vous standard');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Rendez-vous Standard</h2>
          <p className="text-muted-foreground">Gérez tous les rendez-vous standard</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Liste des rendez-vous standard</CardTitle>
          <CardDescription>
